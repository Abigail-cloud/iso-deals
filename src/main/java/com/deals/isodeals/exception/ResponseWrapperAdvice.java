...
public class ResponseWrapperAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object object, MethodParameter methodParameter, MediaType mediaType,
        ...
        com.deals.isodeals.exception.GenericResponse<Object> genericResponse = new com.deals.isodeals.exception.GenericResponse<>();
    ...
    private ErrorResponse problemDelegator(Exception exception, Locale locale) {
        ...
        if(exception instanceof CustomApiException) {
        ...
        } else if (exception instanceof ValidationDealException) {
            ValidationDealException ex = (ValidationDealException)exception;
            ...
            List<String> messages = CollectionUtils.isEmpty(ex.getValidationErrors())
                ? List.of()
                : ex.getValidationErrors().stream().filter(Objects::nonNull).map(localeMapper).collect(Collectors.toList());
            ...
            response.setStatusCode((short)responseStatusException.hashCode());
